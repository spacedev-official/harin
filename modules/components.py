...
class Start(discord.ui.View):
    ...
    @discord.ui.button(label="시작", style=discord.ButtonStyle.green)
...
class PlayerRoles(discord.ui.View):
    ...
    @discord.ui.button(label='직업 확인하기', style=discord.ButtonStyle.primary)
...
class RoleActivate(discord.ui.View):
    ...
    @discord.ui.button(label='능력 사용하기', style=discord.ButtonStyle.primary)
...
class UserSelect(discord.ui.Select):
    def __init__(self, bot, data: dict, night: bool):
        ...
        select_options = [discord.SelectOption(label=u.name) for u in self.users]
        if night is False:
...
class Vote(discord.ui.View):
    ...
    @discord.ui.button(label='투표하기', style=discord.ButtonStyle.primary)
...
class VoteTime(discord.ui.View):
    ...
    @discord.ui.button(label="증가", style=discord.ButtonStyle.green)
    ...
    @discord.ui.button(label="단축", style=discord.ButtonStyle.red)
